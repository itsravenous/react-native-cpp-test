...
RCT_EXPORT_METHOD(createFingerPrint:(nonnull NSDictionary *)newFingerprint compareWith:(nonnull NSDictionary *)existingFingerprint resolver:(RCTPromiseResolveBlock)resolve
withReject:(RCTPromiseRejectBlock)reject)
{
