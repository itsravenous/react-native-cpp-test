...
RCT_EXPORT_METHOD(subtract:(nonnull NSNumber*)a withB:(nonnull NSNumber*)b resolver:(RCTPromiseResolveBlock)resolve
withReject:(RCTPromiseRejectBlock)reject)
{
...
RCT_EXPORT_METHOD(createElement:(nonnull NSNumber[]*)a resolver:(RCTPromiseResolveBlock)resolve
withReject:(RCTPromiseRejectBlock)reject)
{
    // long result = example::subtract([a longValue], [b longValue]);
