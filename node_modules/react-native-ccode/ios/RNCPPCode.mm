...
RCT_EXPORT_METHOD(createFingerPrint:(nonnull NSDictionary *)newFingerprint compareWith:(nonnull NSArray *)existingFingerprints resolver:(RCTPromiseResolveBlock)resolve
withReject:(RCTPromiseRejectBlock)reject)
{
